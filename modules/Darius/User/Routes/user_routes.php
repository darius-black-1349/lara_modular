...
Route::group(['namespace' => 'Darius\User\Http\Controllers', 'middleware' => 'web'], function ($router){
    ...
    Route::middleware('throttle:5,1')
        ->post('/password/reset/check-verify-code ', 'Auth\ForgotPasswordController@checkVerifyCode')
        ->name('password.checkVerifyCode');

    Route::middleware('auth')
        ->get('/password/change', 'Auth\ResetPasswordController@showResetForm')
