...
namespace Darius\User\Http\Controllers\Auth;

use App\Http\Controllers\Controller;
use Darius\User\Http\Requests\ResetPasswordVerifyCodeRequest;
use Darius\User\Http\Requests\SendResetPasswordVerifyCodeRequest;
